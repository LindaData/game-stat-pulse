...
export function SportPage({ title, liveKey, gamesKey, standingsKey }: SportPageProps) {
  ...
  const gameRows = (games?.data as GameRow[] | null) ?? [];
  const standingRows = (standings?.data as StandingRow[] | null) ?? [];
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Historical research data. Not betting advice.
        </p>
      </div>
