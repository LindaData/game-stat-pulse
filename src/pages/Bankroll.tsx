  ...
  return [
    {
      ...
      tone: topOpenSport?.openExposure && summary.exposurePct > 10 ? "red" : "amber" as const,
    },
    {
      ...
      tone: summary.avgClvPct != null && summary.avgClvPct >= 0 ? "green" : "amber" as const,
    },
    {
      ...
      tone: bestSettledSport?.settledProfit && bestSettledSport.settledProfit >= 0 ? "green" : "amber" as const,
    },
  ];
}
